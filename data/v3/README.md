...
当前 Boss 采集因平台风控暂停，禁止自动浏览和拟人化采集。正式数据渠道已经扩展为深i人才、广东公共招聘、企业官方招聘页、猎聘公开岗位页与少量 Boss 人工复核证据。来源许可范围见 `config/source-registry.json`，真实性硬门槛见 `config/authenticity-policy.json`。
