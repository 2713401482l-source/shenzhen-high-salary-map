  ...
  return <ShaderBoundary>
    <Shader className="hero-shader hero-shader-interactive" disableTelemetry toneMapping="neutral">
      <FilmGrain strength={0.045} bias={2} animated>
        <FlutedGlass aberration={0.92} angle={31} frequency={7.3} highlight={0.48} highlightSoftness={0.16} highlightColor="#ffffff" lightAngle={-82} refraction={4.2} shape="rounded" softness={0.7} speed={0.24} waveAmplitude={0.11} waveFrequency={1.8} edges="mirror">
